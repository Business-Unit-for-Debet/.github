# Business-Unit-for-Debet

Debet business unit organization.

## Standard Repositories

- [`requirements`](https://github.com/Business-Unit-for-Debet/requirements): product/business requirements, scope, workflows, acceptance criteria, and open questions.
- [`deploy`](https://github.com/Business-Unit-for-Debet/deploy): deployment orchestration, domains, CI/CD release notes, environment mapping, and operations docs.
- [`.github`](https://github.com/Business-Unit-for-Debet/.github): organization profile and repository map.
